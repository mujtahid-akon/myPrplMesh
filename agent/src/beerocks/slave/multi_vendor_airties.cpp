...
public:
    ...
    multi_vendor_airties()
    {
        ...
        // Register the Airties OUI into the vector vendors_oui that is inherits
        // from class multi_vendor::tlvf_handler.
        vendors_oui.push_back(AIRTIES_OUI);
        ...
        for (auto msg_type : m_message_types) {
            ...
            case ieee1905_1::eMessageType::AP_AUTOCONFIGURATION_WSC_MESSAGE: {
                ...
                tlv_function_table[std::make_pair(
                                       AIRTIES_OUI,
                                       ieee1905_1::eMessageType::AP_AUTOCONFIGURATION_WSC_MESSAGE)]
                    .push_back(add_airties_msgtype_tlv);
                break;
            }
