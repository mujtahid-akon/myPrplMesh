...
class tlvAvailableSpectrumInquiryRequest : public BaseClass
{
    public:
        ...
        size_t available_spectrum_inquiry_request_obj_length() { return m_available_spectrum_inquiry_request_obj_idx__ * sizeof(uint8_t); }
        uint8_t* available_spectrum_inquiry_request_obj(size_t idx = 0);
        bool set_available_spectrum_inquiry_request_obj(const void* buffer, size_t size);
        bool alloc_available_spectrum_inquiry_request_obj(size_t count = 1);
    ...
    private:
        ...
        uint8_t* m_available_spectrum_inquiry_request_obj = nullptr;
        size_t m_available_spectrum_inquiry_request_obj_idx__ = 0;
