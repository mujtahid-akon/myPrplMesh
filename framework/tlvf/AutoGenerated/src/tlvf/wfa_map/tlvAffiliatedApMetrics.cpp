...
uint32_t& tlvAffiliatedApMetrics::unicast_bytes_sent() {
    return (uint32_t&)(*m_unicast_bytes_sent);
}

uint32_t& tlvAffiliatedApMetrics::unicast_bytes_received() {
    return (uint32_t&)(*m_unicast_bytes_received);
}

uint32_t& tlvAffiliatedApMetrics::multicast_bytes_sent() {
    return (uint32_t&)(*m_multicast_bytes_sent);
}

uint32_t& tlvAffiliatedApMetrics::multicast_bytes_received() {
    return (uint32_t&)(*m_multicast_bytes_received);
}

uint32_t& tlvAffiliatedApMetrics::broadcast_bytes_sent() {
    return (uint32_t&)(*m_broadcast_bytes_sent);
}

uint32_t& tlvAffiliatedApMetrics::broadcast_bytes_received() {
